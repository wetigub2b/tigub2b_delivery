      ...
      <div v-if="show" class="modal-overlay" @click="handleCancel">
        <div class="modal-container" @click.stop>
          <div class="modal-header">
            <h3>{{ $t('orderCard.deliveryProof') }}</h3>
          ...
          <div class="modal-body">
            ...
            <div class="notes-section">
              <label for="delivery-notes">{{ $t('orderCard.deliveryNotes') }}</label>
              <textarea
                id="delivery-notes"
                v-model="notes"
                :placeholder="$t('orderCard.deliveryNotesPlaceholder')"
                rows="3"
                maxlength="1000"
              ></textarea>
          ...
          <div class="modal-footer">
            ...
            >
              {{ isProcessing ? $t('common.loading') : $t('orderCard.submitDelivery') }}
            </button>
          </div>
        </div>
      </div>
...
async function handleSubmit() {
  ...
  try {
    ...
    photoError.value = 'Failed to submit delivery proof';
