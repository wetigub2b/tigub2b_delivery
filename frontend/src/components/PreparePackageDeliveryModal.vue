        ...
        <div class="modal-container" @click.stop>
          ...
          <div class="modal-body">
            ...
            <div class="notes-section">
              <label for="delivery-notes">{{ $t('taskBoard.deliveryNotes') }}</label>
              <textarea
                id="delivery-notes"
                v-model="notes"
                :placeholder="$t('taskBoard.deliveryNotesPlaceholder')"
                rows="3"
                maxlength="500"
              ></textarea>
          ...
          <div class="modal-footer">
            ...
            >
              {{ isProcessing ? $t('common.loading') : $t('taskBoard.submitDelivery') }}
            </button>
          </div>
        </div>
      </div>
